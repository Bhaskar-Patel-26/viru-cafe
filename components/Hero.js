  ...
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        <div className="hero-badge">Now Open · Raipur's Finest Cafe</div>
        <h1 className="hero-title">
          <span className="brand">Viru Cafe ☕</span>
          Best Coffee & Chill Place
        </h1>
        <p className="hero-sub">Best Coffee & Chill Place</p>
